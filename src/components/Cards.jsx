...
export default function Cards({ img, name, population, region, capital, darkMode }) {
    ...
    return (
        <div className={`w-72 h-96 shadow-xl rounded-md overflow-hidden pb-36 ${darkMode ? 'bg-slate-900' : 'bg-white'}`}>
            ...
            <div className="flex flex-col px-4 py-4 h-48 overflow-y-auto">
